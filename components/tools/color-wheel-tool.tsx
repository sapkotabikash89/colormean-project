    ...
    <div className="space-y-4 sm:space-y-8">
      ...
      <Card className="p-2 sm:p-6 space-y-3 sm:space-y-4">
        ...
        <ol className="list-decimal list-inside space-y-2 text-sm sm:text-base text-muted-foreground">
          <li>Select your base color using the color picker</li>
          ...
          <li>Click on any color to explore it in detail or click "Explore" button</li>
      ...
      <Card className="p-2 sm:p-6 space-y-3 sm:space-y-4">
        ...
        <Accordion type="single" collapsible>
          <AccordionItem value="item-1">
            <AccordionTrigger className="text-sm sm:text-base">What is a color wheel?</AccordionTrigger>
          ...
          <AccordionItem value="item-3">
            <AccordionTrigger className="text-sm sm:text-base">Can I use these colors commercially?</AccordionTrigger>
            <AccordionContent className="text-sm">
