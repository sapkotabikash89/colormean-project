        ...
        <div className="px-3 py-3 sm:px-0 sm:py-0 space-y-4">
          ...
          <Accordion type="single" collapsible>
            <AccordionItem value="item-1">
              <AccordionTrigger>How accurate are color blindness simulators?</AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value="item-2">
              <AccordionTrigger>Can color blindness be cured?</AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value="item-3">
              <AccordionTrigger>Why is designing for color blindness important?</AccordionTrigger>
              <AccordionContent>
